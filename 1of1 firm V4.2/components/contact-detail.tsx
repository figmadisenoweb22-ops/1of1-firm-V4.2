...
export default function ContactDetail({ onNavigate }: ContactDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[45vh] sm:min-h-[50vh] md:min-h-[60vh] flex items-end">
        {/* Background Image */}
        <div 
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 md:px-12 pb-8 sm:pb-10 md:pb-12 pt-24">
          <h1 
            className="text-[1.25rem] sm:text-[1.5rem] md:text-[7rem] lg:text-[9rem] font-light leading-[0.85] tracking-tight text-white"
