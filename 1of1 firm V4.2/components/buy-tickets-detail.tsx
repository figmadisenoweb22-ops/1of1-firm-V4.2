...
import { X, Clock, MapPin, Calendar, Users, ExternalLink, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative pt-20">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=1200&q=80')`,
          }}
        />
      ...
      <main className="px-2 sm:px-3 md:px-8 pb-6 sm:pb-8 space-y-3 sm:space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-4 sm:mt-6">
          ...
          {/* Limited Spots CTA */}
          <div 
            className="bg-zinc-900/60 border border-white/10 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 flex flex-col items-center justify-center text-center relative overflow-hidden"
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600&q=80')`,
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              <div>
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  <span className="text-base sm:text-lg md:text-xl font-bold tracking-wider">ANIMAL</span>
